...
const Hero: React.FC = () => {
  return (
    <div className="hero flex     relative w-full h-[100vh]  ">
      <div className="hero-info  sm:autoBlur  bottom-[2%]   md:bottom-[20%] md:left-[5%]   absolute left-[9%]    ">
      ...
      <div className="hero-vid-box bottom-[48%]   sm:bottom-[-15%] absolute right-[0%] pl-4 sm:pl-0 ">
        <video
          className="sm:autoBlur max-h-[900px] mix-blend-lighten "
          autoPlay
          loop
          muted
          playsInline
      ...
      <div className="scroll-down w-[30px]   h-[50px] absolute left-[58%] sm:left-[49%] bottom-[2.2%]  sm:bottom-[8%] rounded-[50px] cursor-pointer shadow-[0_0_15px_rgba(211,211,211,0.477)]  border-2 border-[lightgray]">
        <Lottie
