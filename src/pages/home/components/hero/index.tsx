...
const Hero: React.FC = () => {
  return (
    <div className="hero flex     relative w-full h-[100vh]  ">
      <div className="hero-info  sm:autoBlur  bottom-[2%] sm:bottom-[20%]  absolute left-[4%] sm:left-[5%]    ">
      ...
      <div className="hero-vid-box bottom-[48%]   sm:bottom-[-15%] absolute right-[0%]  ">
        <video
      ...
      <div className="scroll-down w-[30px]   h-[50px] absolute left-[55%] sm:left-[49%] bottom-[20px]  sm:bottom-[8%] rounded-[50px] cursor-pointer shadow-[0_0_15px_rgba(211,211,211,0.477)]  border-2 border-[lightgray]">
        <Lottie
