...
const Header: React.FC = () => {
  return (
    <div className="header-box  sticky flex w-[100%] h-[50px] sm:h-[70px] top-0 left-0 right-0 items-center justify-between  bg-[rgba(255,255,255,0.113)] backdrop-blur-[10px] px-[30px] py-0 shadow-[0_0_15px_#72a1de68] z-[999] ">
      ...
      <ul className="hidden sm:flex  justify-between w-[30%] py-[15px] px-[15px] rounded-[50px] bg-[rgba(0,0,69,0.30)] backdrop-blur-[10px] shadow-[0_0_15px_#727fde65]">
      ...
      <div className="box-icons hidden sm:flex gap-[40px]">
        <a
