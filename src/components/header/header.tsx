...
const Header: React.FC = () => {
  return (
    <div className="header-box  sticky flex w-[100%] h-[70px] top-0 left-0 right-0 items-center justify-between  bg-[rgba(255,255,255,0.113)] backdrop-blur-[10px] px-[30px] py-0 shadow-[0_0_15px_#72a1de68] z-[999] ">
