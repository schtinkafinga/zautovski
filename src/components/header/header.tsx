...
const Header: React.FC = () => {
  return (
    <header className="sticky top-0 left-0 right-0 z-[999] w-full h-[70px] px-[30px] bg-[rgba(255,255,255,0.113)] backdrop-blur-[10px] shadow-[0_0_15px_#72a1de68] flex items-center justify-between">
      ...
      {/* Navigation Links */}
      <ul className="hidden md:flex items-center justify-between bg-[rgba(0,0,69,0.30)] backdrop-blur-[10px] shadow-[0_0_15px_#727fde65] rounded-[50px] py-[15px] px-[15px] lg:w-[30%]">
      ...
      <div className="hidden md:flex gap-[40px]">
        {socialLinks.map(({ href, icon }, idx) => (
          <a
            ...
            className="w-[30px] h-[30px] flex items-center justify-center rounded-full border-2 border-[#727fde] text-[20px] text-lightgray no-underline transition duration-300 hover:bg-[#727fde] hover:text-black shadow-[0_0_15px_#727fde6f]"
          >
