...
const Header: React.FC = () => {
  return (
    <div className="header-box flex absolute top-0 left-0 right-0 items-center justify-between h-[70px] bg-[rgba(255,255,255,0.113)] backdrop-blur-[10px] px-[30px] py-0 shadow-[0_0_15px_#72a1de68] z-[999] ">
      <div className="left flex items-center justify-center  h-full">
        <img src="images/logo1.png" alt="logo" className="w-[70px]  h-full mr-2" />
